...
interface Element {
	className: string;
	addEventListener: (type: string, callback: ((event?: Event) => void), useCaputre?: boolean) => void;
	removeEventListener: (type: string, callback: ((event?: Event) => void), useCaputre?: boolean) => void;
	focus: () => void;
}
