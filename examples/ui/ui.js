requirejs([
	...
	'../../build/client/emitters/ui',
], function(electric, ui) {
    ...
    downs = trackpad.filter(false, function(o){return !o || o.type === 'down'});
    ups = trackpad.filter(false, function(o){return !o || o.type === 'up'});
