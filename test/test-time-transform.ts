...
// 		var r: number[] = [];
// 		// optional t0
// 		emitter.transformTime((t: number) => t + 2).plugReceiver(
// 			(x: number) => r.push(x)
// 		);
...
// 		var emitter = electric.emitter.manual(0);
// 		var r: number[] = [];
// 		emitter.transformTime((t: number) => -1).plugReceiver(
// 			(x: number) => r.push(x)
// 		);
// 		emitter.emit(1);
// 		emitter.emit(2);
...
// 		var emitter = electric.emitter.manual(0);
// 		var r: number[][] = [];
// 		emitter.transformTime((t: number) => { return t * 2 }, time).plugReceiver(
