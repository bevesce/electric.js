...
// 			emitter2
// 		);
// 		expect(transformator).to.emitD.values({x: 0, y: 0})
//     });
// });
...
//         var emitter = electric.emitter.manual(0);
//         var filteredEmitter = emitter.filter(2, (x: number) => x > 2);
//         expect(filteredEmitter).to.emitD.values(2);
//     });
// });
...
//             emitter1, emitter2
// 		);
// 		expect(mergedEmitter).to.emitD.values(1);
//     });
// });
...
//             emitter1, emitter2
// 		);
// 		expect(accumulatedEmitter).to.emitD.values(1);
//     });
// });
...
//         var emittedEmitter2 = electric.emitter.manual(0);
//         var flattenedEmitter = electric.transformator.flatten(emitter);
//         expect(flattenedEmitter).to.emitD.values(2);
//     });
// });
...
//         );
//         expect(samplingTransformator).to.emitD
//             .values(0)
//             .then.afterD(() => {
//                 sampler1.impulse(1);
//                 sampler2.impulse(2);
...
//             emitter, sampler1, sampler2
// 		);
// 		expect(samplingTransformator).to.emitD.values(1);
//     });
// });
...
//         var emitter = electric.emitter.manual(0);
//         var throttleTransformator = electric.transformator.throttle(1, emitter);
//         expect(throttleTransformator).to.emitD.values([]);
//     });
// });
...
//     it('should have initial value', function() {
//         var emitter = electric.emitter.manual(0);
// 		expect(emitter.changes()).to.emitD.values(
//             { previous: undefined, current: 0 }
// 		);
//     });
// });
...
//             when: emitter2
//         });
//         (<any>expect(switcher)).to.emitD.afterD(() => {
//             emitter1.emit('1-1');
//             emitter2.impulse(2);
//             emitter1.emit('1-2');
//             emitter1.emit('1-3');
...
//             when: emitter2
//         });
//         (<any>expect(switcher)).to.emitD.values('1-0');
//     });
